...
class AlohaTwoArmConfig(BaseDataConfig):
    video_keys = ["video.cam_high", "video.cam_wrist_left", "video.cam_wrist_right"]
    state_keys = [
        "state.left_arm",
        "state.right_arm",
        # "state.velocity_right_arm",
...
class VRH31LeftArmLeftHand3Cam(BaseDataConfig):
    video_keys = ["video.cam_head", "video.cam_left", "video.cam_right"]
    state_keys = [
        # "state.left_arm",
        # "state.right_arm",
...
class VRH31GripperBothExcludeTaskProgress(BaseDataConfig):
    video_keys = ["video.cam_head", "video.cam_left", "video.cam_right"]
    state_keys = [
        # "state.left_arm",
        # "state.right_arm",
...
DATA_CONFIG_MAP = {
    ...
    "aloha_both_arm": AlohaTwoArmConfig(),
    ...
    "vrh31_gripper_action": VRH31GripperAction(),
